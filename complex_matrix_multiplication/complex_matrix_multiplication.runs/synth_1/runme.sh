...
HD_PWD='C:/Codes/Verilog/complex_matrix_multiplication/complex_matrix_multiplication.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ComplexMatrixMultiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ComplexMatrixMultiplier.tcl
